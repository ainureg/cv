...
\education{
    ...
    МФТИ \\
    2022 | Moscow\\
    \small{still not graduated, only diploma left}
...
\aboutme{prefer opensource, always involved in self- and professional development. Currently I am a student of MIPT} % To have no About Me section, just remove all the text and leave \aboutme{}

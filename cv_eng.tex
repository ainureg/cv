...
\education{
    ...
    МФТИ \\
    2017 | Moscow\\
    \small{not graduated, only diploma left}
...
\aboutme{prefer opensource, always involved in self- and professional development. Currently I am working for MSc diploma of MIPT} % To have no About Me section, just remove all the text and leave \aboutme{}
...
\skills{{Python * Linux * \LaTeX /5},{R * C++/3}, {git * bash * docker * airflow/ 4 }}
